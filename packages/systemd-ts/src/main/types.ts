...
/** @deprecated Prefer a directive-specific alias such as BooleanDirectiveValues or DurationDirectiveValues. */
export type ScalarDirectiveValues = DirectiveValue<ScalarDirectiveValue>;
export type DirectiveValue<TValue> = TValue | readonly TValue[];
export type BooleanDirectiveValues = DirectiveValue<boolean>;
export type StringDirectiveValues = DirectiveValue<string>;
export type NumericDirectiveValues = DirectiveValue<number | string>;
export type DurationDirectiveValues = DirectiveValue<number | string>;
export type UnitNameDirectiveValues = DirectiveValue<string>;
export type PathDirectiveValues = DirectiveValue<string>;
export type SignalDirectiveValues = DirectiveValue<NodeJS.Signals | number>;
export type ExitStatusDirectiveValues = DirectiveValue<string | number>;
...
export interface SystemdUnitSection extends CustomDirectiveSection {
  ...
  readonly After?: UnitNameDirectiveValues;
  ...
  readonly AllowIsolate?: BooleanDirectiveValues;
  ...
  readonly AssertACPower?: BooleanDirectiveValues;
  ...
  readonly AssertArchitecture?: StringDirectiveValues;
  ...
  readonly AssertCPUFeature?: StringDirectiveValues;
  ...
  readonly AssertCPUPressure?: StringDirectiveValues;
  ...
  readonly AssertCPUs?: StringDirectiveValues;
  ...
  readonly AssertCapability?: StringDirectiveValues;
  ...
  readonly AssertControlGroupController?: StringDirectiveValues;
  /** Assertion form of `ConditionCredential=`. ConditionCredential= may be used to check whether a credential by the specified name was passed into the service manager. See System and Service Credentials for details about credentials. If used in services for the system service manager this may be used to conditionalize services based on system credentials passed in. If used in services for the per-user service manager this may be used to conditionalize services based on credentials passed into the unit@.service service instance belonging to the user. The argument must be a valid credential name. Unlike conditions, a mismatch fails the start job instead of skipping it. Source: systemd v260.1, `systemd.unit(5)`. */
  readonly AssertCredential?: StringDirectiveValues;
  /** Assertion form of `ConditionDirectoryNotEmpty=`. ConditionDirectoryNotEmpty= is similar to ConditionPathExists= but verifies that a certain path exists and is a non-empty directory. Unlike conditions, a mismatch fails the start job instead of skipping it. Source: systemd v260.1, `systemd.unit(5)`. */
  readonly AssertDirectoryNotEmpty?: StringDirectiveValues;
  /** Assertion form of `ConditionEnvironment=`. ConditionEnvironment= may be used to check whether a specific environment variable is set (or if prefixed with the exclamation mark — unset) in the service manager's environment block. The argument may be a single word, to check if the variable with this name is defined in the environment block, or an assignment (name=value), to check if the variable with this exact value is defined. Note that the environment block of the service manager itself is checked, i.e. not any variables defined with Environment= or EnvironmentFile=, as described above. This is particularly useful when the service manager runs inside a containerized environment or as per-user service manager, in order to check for variables passed in by the enclosing container manager or PAM. Unlike conditions, a mismatch fails the start job instead of skipping it. Source: systemd v260.1, `systemd.unit(5)`. */
  readonly AssertEnvironment?: StringDirectiveValues;
  /** Assertion form of `ConditionFileIsExecutable=`. ConditionFileIsExecutable= is similar to ConditionPathExists= but verifies that a certain path exists, is a regular file, and marked executable. Unlike conditions, a mismatch fails the start job instead of skipping it. Source: systemd v260.1, `systemd.unit(5)`. */
  readonly AssertFileIsExecutable?: StringDirectiveValues;
  /** Assertion form of `ConditionFileNotEmpty=`. ConditionFileNotEmpty= is similar to ConditionPathExists= but verifies that a certain path exists and refers to a regular file with a non-zero size. Unlike conditions, a mismatch fails the start job instead of skipping it. Source: systemd v260.1, `systemd.unit(5)`. */
  readonly AssertFileNotEmpty?: StringDirectiveValues;
  ...
  readonly AssertMemory?: StringDirectiveValues;
  /** Assertion form of `ConditionMemoryPressure=`. Verify that the overall system (memory, CPU or IO) pressure is below or equal to a threshold. This setting takes a threshold value as argument. It can be specified as a simple percentage value, suffixed with %, in which case the pressure will be measured as an average over the last five minutes before the attempt to start the unit is performed. Alternatively, the average timespan can also be specified using / as a separator, for example: 10%/1min. The supported timespans match what the kernel provides, and are limited to 10sec, 1min and 5min. The full PSI will be checked first, and if not found some will be checked. For more details, see the documentation on PSI (Pressure Stall Information) . Unlike conditions, a mismatch fails the start job instead of skipping it. Source: systemd v260.1, `systemd.unit(5)`. */
  readonly AssertMemoryPressure?: StringDirectiveValues;
  ...
  readonly AssertNeedsUpdate?: StringDirectiveValues;
  ...
  readonly AssertOSRelease?: StringDirectiveValues;
  ...
  readonly AssertPathExists?: StringDirectiveValues;
  /** Assertion form of `ConditionPathExistsGlob=`. ConditionPathExistsGlob= is similar to ConditionPathExists=, but checks for the existence of at least one file or directory matching the specified globbing pattern. Unlike conditions, a mismatch fails the start job instead of skipping it. Source: systemd v260.1, `systemd.unit(5)`. */
  readonly AssertPathExistsGlob?: StringDirectiveValues;
  /** Assertion form of `ConditionPathIsDirectory=`. ConditionPathIsDirectory= is similar to ConditionPathExists= but verifies that a certain path exists and is a directory. Unlike conditions, a mismatch fails the start job instead of skipping it. Source: systemd v260.1, `systemd.unit(5)`. */
  readonly AssertPathIsDirectory?: StringDirectiveValues;
  /** Assertion form of `ConditionPathIsEncrypted=`. ConditionPathIsEncrypted= is similar to ConditionPathExists= but verifies that the underlying file system's backing block device is encrypted using dm-crypt/LUKS. Note that this check does not cover ext4 per-directory encryption, and only detects block level encryption. Moreover, if the specified path resides on a file system on top of a loopback block device, only encryption above the loopback device is detected. It is not detected whether the file system backing the loopback block device is encrypted. Unlike conditions, a mismatch fails the start job instead of skipping it. Source: systemd v260.1, `systemd.unit(5)`. */
  readonly AssertPathIsEncrypted?: StringDirectiveValues;
  /** Assertion form of `ConditionPathIsMountPoint=`. ConditionPathIsMountPoint= is similar to ConditionPathExists= but verifies that a certain path exists and is a mount point. Unlike conditions, a mismatch fails the start job instead of skipping it. Source: systemd v260.1, `systemd.unit(5)`. */
  readonly AssertPathIsMountPoint?: StringDirectiveValues;
  /** Assertion form of `ConditionPathIsReadWrite=`. ConditionPathIsReadWrite= is similar to ConditionPathExists= but verifies that the underlying file system is readable and writable (i.e. not mounted read-only). Unlike conditions, a mismatch fails the start job instead of skipping it. Source: systemd v260.1, `systemd.unit(5)`. */
  readonly AssertPathIsReadWrite?: StringDirectiveValues;
  /** Assertion form of `ConditionPathIsSocket=`. ConditionPathIsSocket= is similar to ConditionPathExists= but verifies that a certain path exists and is a socket. Unlike conditions, a mismatch fails the start job instead of skipping it. Source: systemd v260.1, `systemd.unit(5)`. */
  readonly AssertPathIsSocket?: StringDirectiveValues;
  /** Assertion form of `ConditionPathIsSymbolicLink=`. ConditionPathIsSymbolicLink= is similar to ConditionPathExists= but verifies that a certain path exists and is a symbolic link. Unlike conditions, a mismatch fails the start job instead of skipping it. Source: systemd v260.1, `systemd.unit(5)`. */
  readonly AssertPathIsSymbolicLink?: StringDirectiveValues;
  /** Assertion form of `ConditionSecurity=`. ConditionSecurity= may be used to check whether the given security technology is enabled on the system. Currently, the following values are recognized:. Unlike conditions, a mismatch fails the start job instead of skipping it. Source: systemd v260.1, `systemd.unit(5)`. */
  readonly AssertSecurity?: StringDirectiveValues;
  /** Assertion form of `ConditionUser=`. ConditionUser= takes a numeric UID, a UNIX user name, or the special value @system. This condition may be used to check whether the service manager is running as the given user. The special value @system can be used to check if the user id is within the system user range. This option is not useful for system services, as the system manager exclusively runs as the root user, and thus the test result is constant. Unlike conditions, a mismatch fails the start job instead of skipping it. Source: systemd v260.1, `systemd.unit(5)`. */
  readonly AssertUser?: StringDirectiveValues;
  /** Assertion form of `ConditionVersion=`. ConditionVersion= may be used to check whether a software version matches a certain expression, or if prefixed with the exclamation mark, does not match. The first argument is the software whose version has to be checked. Currently kernel, systemd and glibc are supported. If this argument is omitted, kernel is implied. The second argument must be a list of (potentially quoted) expressions. Each expression starts with one of = or != for string comparisons, <, <=, ==, <>, >=, > for version comparisons, or $=, !$= for a shell-style glob match. If no operator is specified, $= is implied. Unlike conditions, a mismatch fails the start job instead of skipping it. Source: systemd v260.1, `systemd.unit(5)`. */
  readonly AssertVersion?: StringDirectiveValues;
  ...
  readonly AssertVirtualization?: DirectiveValue<boolean | string>;
  /** Units that should be ordered after this unit starts. Source: systemd v260.1, `systemd.unit(5)`. */
  readonly Before?: UnitNameDirectiveValues;
  ...
  readonly BindsTo?: UnitNameDirectiveValues;
  ...
  readonly CollectMode?: DirectiveValue<"inactive" | "inactive-or-failed">;
  ...
  readonly ConditionACPower?: BooleanDirectiveValues;
  ...
  readonly ConditionCPUs?: StringDirectiveValues;
  ...
  readonly ConditionCapability?: StringDirectiveValues;
  ...
  readonly ConditionControlGroupController?: StringDirectiveValues;
  ...
  readonly ConditionCredential?: StringDirectiveValues;
  /** ConditionDirectoryNotEmpty= is similar to ConditionPathExists= but verifies that a certain path exists and is a non-empty directory. Source: systemd v260.1, `systemd.unit(5)`. */
  readonly ConditionDirectoryNotEmpty?: StringDirectiveValues;
  ...
  readonly ConditionEnvironment?: StringDirectiveValues;
  /** ConditionFileIsExecutable= is similar to ConditionPathExists= but verifies that a certain path exists, is a regular file, and marked executable. Source: systemd v260.1, `systemd.unit(5)`. */
  readonly ConditionFileIsExecutable?: StringDirectiveValues;
  /** ConditionFileNotEmpty= is similar to ConditionPathExists= but verifies that a certain path exists and refers to a regular file with a non-zero size. Source: systemd v260.1, `systemd.unit(5)`. */
  readonly ConditionFileNotEmpty?: NumericDirectiveValues;
  ...
  readonly ConditionFirmware?: StringDirectiveValues;
  ...
  readonly ConditionFirstBoot?: BooleanDirectiveValues;
  /** ConditionGroup= is similar to ConditionUser= but verifies that the service manager's real or effective group, or any of its auxiliary groups, match the specified group or GID. This setting does not support the special value @system. Source: systemd v260.1, `systemd.unit(5)`. */
  readonly ConditionGroup?: StringDirectiveValues;
  /** ConditionHost= may be used to match against the hostname, machine ID, boot ID or product UUID of the host. This either takes a hostname string (optionally with shell style globs) which is tested against the locally set hostname as returned by gethostname2, or a 128bit ID or UUID, formatted as string. The latter is compared against machine ID, boot ID and the firmware product UUID if there is any. See machine-id(5) for details about the machine ID. The test may be negated by prepending an exclamation mark. Source: systemd v260.1, `systemd.unit(5)`. */
  readonly ConditionHost?: StringDirectiveValues;
  /** Verify that the overall system (memory, CPU or IO) pressure is below or equal to a threshold. This setting takes a threshold value as argument. It can be specified as a simple percentage value, suffixed with %, in which case the pressure will be measured as an average over the last five minutes before the attempt to start the unit is performed. Alternatively, the average timespan can also be specified using / as a separator, for example: 10%/1min. The supported timespans match what the kernel provides, and are limited to 10sec, 1min and 5min. The full PSI will be checked first, and if not found some will be checked. For more details, see the documentation on PSI (Pressure Stall Information) . Source: systemd v260.1, `systemd.unit(5)`. */
  readonly ConditionIOPressure?: StringDirectiveValues;
  ...
  readonly ConditionKernelCommandLine?: StringDirectiveValues;
  ...
  readonly ConditionKernelModuleLoaded?: StringDirectiveValues;
  ...
  readonly ConditionKernelVersion?: StringDirectiveValues;
  ...
  readonly ConditionMemory?: NumericDirectiveValues;
  /** Verify that the overall system (memory, CPU or IO) pressure is below or equal to a threshold. This setting takes a threshold value as argument. It can be specified as a simple percentage value, suffixed with %, in which case the pressure will be measured as an average over the last five minutes before the attempt to start the unit is performed. Alternatively, the average timespan can also be specified using / as a separator, for example: 10%/1min. The supported timespans match what the kernel provides, and are limited to 10sec, 1min and 5min. The full PSI will be checked first, and if not found some will be checked. For more details, see the documentation on PSI (Pressure Stall Information) . Source: systemd v260.1, `systemd.unit(5)`. */
  readonly ConditionMemoryPressure?: StringDirectiveValues;
  /** Takes one of /var/ or /etc/ as argument, possibly prefixed with a ! (to invert the condition). This condition may be used to conditionalize units on whether the specified directory requires an update because /usr/'s modification time is newer than the stamp file .updated in the specified directory. This is useful to implement offline updates of the vendor operating system resources in /usr/ that require updating of /etc/ or /var/ on the next following boot. Units making use of this condition should order themselves before systemd-update-done.service8, to make sure they run before the stamp file's modification time gets reset indicating a completed update. Source: systemd v260.1, `systemd.unit(5)`. */
  readonly ConditionNeedsUpdate?: StringDirectiveValues;
  /** Verify that a specific key=value pair is set in the host's os-release5. Source: systemd v260.1, `systemd.unit(5)`. */
  readonly ConditionOSRelease?: StringDirectiveValues;
  ...
  readonly ConditionPathExists?: StringDirectiveValues;
  /** ConditionPathExistsGlob= is similar to ConditionPathExists=, but checks for the existence of at least one file or directory matching the specified globbing pattern. Source: systemd v260.1, `systemd.unit(5)`. */
  readonly ConditionPathExistsGlob?: StringDirectiveValues;
  /** ConditionPathIsDirectory= is similar to ConditionPathExists= but verifies that a certain path exists and is a directory. Source: systemd v260.1, `systemd.unit(5)`. */
  readonly ConditionPathIsDirectory?: StringDirectiveValues;
  ...
  readonly ConditionPathIsEncrypted?: StringDirectiveValues;
  /** ConditionPathIsMountPoint= is similar to ConditionPathExists= but verifies that a certain path exists and is a mount point. Source: systemd v260.1, `systemd.unit(5)`. */
  readonly ConditionPathIsMountPoint?: StringDirectiveValues;
  /** ConditionPathIsReadWrite= is similar to ConditionPathExists= but verifies that the underlying file system is readable and writable (i.e. not mounted read-only). Source: systemd v260.1, `systemd.unit(5)`. */
  readonly ConditionPathIsReadWrite?: StringDirectiveValues;
  /** ConditionPathIsSocket= is similar to ConditionPathExists= but verifies that a certain path exists and is a socket. Source: systemd v260.1, `systemd.unit(5)`. */
  readonly ConditionPathIsSocket?: StringDirectiveValues;
  /** ConditionPathIsSymbolicLink= is similar to ConditionPathExists= but verifies that a certain path exists and is a symbolic link. Source: systemd v260.1, `systemd.unit(5)`. */
  readonly ConditionPathIsSymbolicLink?: StringDirectiveValues;
  /** ConditionSecurity= may be used to check whether the given security technology is enabled on the system. Currently, the following values are recognized:. Source: systemd v260.1, `systemd.unit(5)`. */
  readonly ConditionSecurity?: StringDirectiveValues;
  ...
  readonly ConditionUser?: StringDirectiveValues;
  ...
  readonly ConditionVersion?: StringDirectiveValues;
  ...
  readonly ConditionVirtualization?: DirectiveValue<boolean | string>;
  ...
  readonly Conflicts?: UnitNameDirectiveValues;
  ...
  readonly DefaultDependencies?: BooleanDirectiveValues;
  ...
  readonly Description?: StringDirectiveValues;
  ...
  readonly IgnoreOnIsolate?: BooleanDirectiveValues;
  ...
  readonly JobRunningTimeoutSec?: DurationDirectiveValues;
  ...
  readonly JobTimeoutAction?: StringDirectiveValues;
  ...
  readonly JobTimeoutRebootArgument?: StringDirectiveValues;
  ...
  readonly JobTimeoutSec?: DurationDirectiveValues;
  ...
  readonly JoinsNamespaceOf?: StringDirectiveValues;
  ...
  readonly RebootArgument?: StringDirectiveValues;
  ...
  readonly RefuseManualStart?: BooleanDirectiveValues;
  /** If true, this unit can only be activated or deactivated indirectly. In this case, explicit start-up or termination requested by the user is denied, however if it is started or stopped as a dependency of another unit, start-up or termination will succeed. This is mostly a safety feature to ensure that the user does not accidentally activate units that are not intended to be activated explicitly, and not accidentally deactivate units that are not intended to be deactivated. These options default to false. Source: systemd v260.1, `systemd.unit(5)`. */
  readonly RefuseManualStop?: BooleanDirectiveValues;
  /** Units whose reload requests should also reload this unit. Source: systemd v260.1, `systemd.unit(5)`. */
  readonly ReloadPropagatedFrom?: UnitNameDirectiveValues;
  ...
  readonly Requires?: UnitNameDirectiveValues;
  ...
  readonly RequiresMountsFor?: StringDirectiveValues;
  ...
  readonly Requisite?: UnitNameDirectiveValues;
  ...
  readonly SourcePath?: StringDirectiveValues;
  ...
  readonly StartLimitAction?: StringDirectiveValues;
  /** See systemd.unit(5) for StartLimitBurst=. Source: systemd v260.1, `systemd.unit(5)`. */
  readonly StartLimitBurst?: NumericDirectiveValues;
  ...
  readonly StartLimitIntervalSec?: DurationDirectiveValues;
  /** Units whose stop requests should also stop this unit. Source: systemd v260.1, `systemd.unit(5)`. */
  readonly StopPropagatedFrom?: UnitNameDirectiveValues;
  ...
  readonly SurviveFinalKillSignal?: BooleanDirectiveValues;
  ...
  readonly Upholds?: UnitNameDirectiveValues;
...
export interface SystemdInstallSection extends CustomDirectiveSection {
  ...
  readonly Alias?: UnitNameDirectiveValues;
  /** Additional units to install/deinstall when this unit is installed/deinstalled. If the user requests installation/deinstallation of a unit with this option configured, systemctl enable and systemctl disable will automatically install/uninstall units listed in this option as well. Source: systemd v260.1, `systemd.unit(5)`. */
  readonly Also?: UnitNameDirectiveValues;
  ...
  readonly DefaultInstance?: StringDirectiveValues;
  /** Enable-time reverse `Requires=` relationship: enabling this unit creates `.requires/` links from the listed units to it. Source: systemd v260.1, `systemd.unit(5)`. */
  readonly RequiredBy?: UnitNameDirectiveValues;
  /** Enable-time reverse `Upholds=` relationship: enabling this unit creates `.upholds/` links from the listed units to it. Source: systemd v260.1, `systemd.unit(5)`. */
  readonly UpheldBy?: UnitNameDirectiveValues;
  /** Enable-time reverse `Wants=` relationship: enabling this unit creates `.wants/` links from the listed units to it. Source: systemd v260.1, `systemd.unit(5)`. */
  readonly WantedBy?: UnitNameDirectiveValues;
}
...
export interface SystemdTimerSection extends CustomDirectiveSection {
  ...
  readonly AccuracySec?: DurationDirectiveValues;
  ...
  readonly DeferReactivation?: BooleanDirectiveValues;
  ...
  readonly FixedRandomDelay?: BooleanDirectiveValues;
  /** Defines a timer relative to when the timer unit itself is activated. Source: systemd v260.1, `systemd.timer(5)`. */
  readonly OnActiveSec?: DurationDirectiveValues;
  /** Defines a timer relative to machine boot; in containers this is mapped to OnStartupSec= for the system manager. Source: systemd v260.1, `systemd.timer(5)`. */
  readonly OnBootSec?: DurationDirectiveValues;
  /** Defines realtime (i.e. wallclock) timers with calendar event expressions. See systemd.time(7) for more information on the syntax of calendar event expressions. Otherwise, the semantics are similar to OnActiveSec= and related settings. Source: systemd v260.1, `systemd.timer(5)`. */
  readonly OnCalendar?: StringDirectiveValues;
  /** Triggers the associated unit when CLOCK_REALTIME jumps relative to CLOCK_MONOTONIC. Source: systemd v260.1, `systemd.timer(5)`. */
  readonly OnClockChange?: BooleanDirectiveValues;
  /** Defines a timer relative to when the service manager first started, which is especially useful in per-user managers. Source: systemd v260.1, `systemd.timer(5)`. */
  readonly OnStartupSec?: DurationDirectiveValues;
  /** Triggers the associated unit when the local system timezone changes. Source: systemd v260.1, `systemd.timer(5)`. */
  readonly OnTimezoneChange?: BooleanDirectiveValues;
  /** Defines a timer relative to when the triggered unit was last activated. Source: systemd v260.1, `systemd.timer(5)`. */
  readonly OnUnitActiveSec?: DurationDirectiveValues;
  /** Defines a timer relative to when the triggered unit was last deactivated. Source: systemd v260.1, `systemd.timer(5)`. */
  readonly OnUnitInactiveSec?: DurationDirectiveValues;
  ...
  readonly Persistent?: BooleanDirectiveValues;
  ...
  readonly RandomizedDelaySec?: DurationDirectiveValues;
  ...
  readonly RandomizedOffsetSec?: DurationDirectiveValues;
  ...
  readonly RemainAfterElapse?: BooleanDirectiveValues;
  ...
  readonly Unit?: UnitNameDirectiveValues;
  ...
  readonly WakeSystem?: BooleanDirectiveValues;
}
...
export interface SystemdServiceSection extends CustomDirectiveSection {
  ...
  readonly AmbientCapabilities?: StringDirectiveValues;
  ...
  readonly AppArmorProfile?: StringDirectiveValues;
  ...
  readonly BPFDelegateAttachments?: StringDirectiveValues;
  ...
  readonly BPFDelegateCommands?: StringDirectiveValues;
  ...
  readonly BPFDelegateMaps?: StringDirectiveValues;
  ...
  readonly BPFDelegatePrograms?: StringDirectiveValues;
  ...
  readonly BPFProgram?: StringDirectiveValues;
  ...
  readonly BindLogSockets?: BooleanDirectiveValues;
  ...
  readonly BindNetworkInterface?: StringDirectiveValues;
  ...
  readonly BindPaths?: StringDirectiveValues;
  /** Configures unit-specific bind mounts. A bind mount makes a particular file or directory available at an additional place in the unit's view of the file system. Any bind mounts created with this option are specific to the unit, and are not visible in the host's mount table. This option expects a whitespace separated list of bind mount definitions. Each definition consists of a colon-separated triple of source path, destination path and option string, where the latter two are optional. If only a source path is specified the source and destination is taken to be the same. The option string may be either rbind or norbind for configuring a recursive or non-recursive bind mount. If the destination path is omitted, the option string must be omitted too. Each bind mount definition may be prefixed with -, in which case it will be ignored when its source path does not exist or is not accessible. Source: systemd v260.1, `systemd.exec(5)`. */
  readonly BindReadOnlyPaths?: StringDirectiveValues;
  ...
  readonly BusName?: StringDirectiveValues;
  ...
  readonly CPUAffinity?: StringDirectiveValues;
  /** This setting controls the cpu controller in the unified hierarchy. Source: systemd v260.1, `systemd.resource-control(5)`. */
  readonly CPUQuota?: NumericDirectiveValues;
  /** This setting controls the cpu controller in the unified hierarchy. Source: systemd v260.1, `systemd.resource-control(5)`. */
  readonly CPUQuotaPeriodSec?: DurationDirectiveValues;
  ...
  readonly CPUSchedulingPolicy?: StringDirectiveValues;
  ...
  readonly CPUSchedulingPriority?: NumericDirectiveValues;
  ...
  readonly CoredumpFilter?: StringDirectiveValues;
  ...
  readonly CoredumpReceive?: BooleanDirectiveValues;
  ...
  readonly Delegate?: StringDirectiveValues;
  ...
  readonly DelegateNamespaces?: DirectiveValue<boolean | string>;
  ...
  readonly DelegateSubgroup?: StringDirectiveValues;
  ...
  readonly DisableControllers?: StringDirectiveValues;
  ...
  readonly DynamicUser?: StringDirectiveValues;
  ...
  readonly Environment?: StringDirectiveValues;
  ...
  readonly EnvironmentFile?: StringDirectiveValues;
  ...
  readonly ExecSearchPath?: ExecutableDirectiveValues;
  ...
  readonly ExitType?: DirectiveValue<"main" | "cgroup">;
  ...
  readonly ExtensionDirectories?: StringDirectiveValues;
  ...
  readonly ExtensionImagePolicy?: StringDirectiveValues;
  ...
  readonly ExtensionImages?: StringDirectiveValues;
  ...
  readonly FileDescriptorStoreMax?: NumericDirectiveValues;
  ...
  readonly FileDescriptorStorePreserve?: StringDirectiveValues;
  ...
  readonly FinalKillSignal?: StringDirectiveValues;
  ...
  readonly Group?: StringDirectiveValues;
  ...
  readonly GuessMainPID?: StringDirectiveValues;
  /** This setting controls the io controller in the unified hierarchy. Source: systemd v260.1, `systemd.resource-control(5)`. */
  readonly IOAccounting?: StringDirectiveValues;
  /** This setting controls the io controller in the unified hierarchy. Source: systemd v260.1, `systemd.resource-control(5)`. */
  readonly IODeviceLatencyTargetSec?: DurationDirectiveValues;
  /** This setting controls the io controller in the unified hierarchy. Source: systemd v260.1, `systemd.resource-control(5)`. */
  readonly IODeviceWeight?: NumericDirectiveValues;
  /** These settings control the io controller in the unified hierarchy. Source: systemd v260.1, `systemd.resource-control(5)`. */
  readonly IOReadBandwidthMax?: StringDirectiveValues;
  /** These settings control the io controller in the unified hierarchy. Source: systemd v260.1, `systemd.resource-control(5)`. */
  readonly IOReadIOPSMax?: StringDirectiveValues;
  ...
  readonly IOSchedulingClass?: StringDirectiveValues;
  ...
  readonly IOSchedulingPriority?: NumericDirectiveValues;
  /** These settings control the io controller in the unified hierarchy. Source: systemd v260.1, `systemd.resource-control(5)`. */
  readonly IOWeight?: NumericDirectiveValues;
  /** See systemd.service(5) for IOWriteBandwidthMax=. Source: systemd v260.1, `systemd.service(5)`. */
  readonly IOWriteBandwidthMax?: StringDirectiveValues;
  /** See systemd.service(5) for IOWriteIOPSMax=. Source: systemd v260.1, `systemd.service(5)`. */
  readonly IOWriteIOPSMax?: StringDirectiveValues;
  ...
  readonly IPAccounting?: BooleanDirectiveValues;
  ...
  readonly IPIngressFilterPath?: StringDirectiveValues;
  ...
  readonly IPCNamespacePath?: StringDirectiveValues;
  ...
  readonly IgnoreSIGPIPE?: BooleanDirectiveValues;
  ...
  readonly ImportCredential?: StringDirectiveValues;
  /** Paths that should be hidden entirely from the service. Source: systemd v260.1, `systemd.exec(5)`. */
  readonly InaccessiblePaths?: StringDirectiveValues;
  ...
  readonly KeyringMode?: StringDirectiveValues;
  ...
  readonly KillMode?: DirectiveValue<"control-group" | "mixed" | "process" | "none">;
  ...
  readonly KillSignal?: SignalDirectiveValues;
  ...
  readonly LimitAS?: NumericDirectiveValues;
  ...
  readonly LimitCORE?: NumericDirectiveValues;
  ...
  readonly LimitCPU?: NumericDirectiveValues;
  ...
  readonly LimitDATA?: NumericDirectiveValues;
  ...
  readonly LimitFSIZE?: NumericDirectiveValues;
  ...
  readonly LimitLOCKS?: NumericDirectiveValues;
  ...
  readonly LimitMEMLOCK?: NumericDirectiveValues;
  ...
  readonly LimitMSGQUEUE?: NumericDirectiveValues;
  ...
  readonly LimitNICE?: NumericDirectiveValues;
  ...
  readonly LimitNOFILE?: NumericDirectiveValues;
  ...
  readonly LimitNPROC?: NumericDirectiveValues;
  ...
  readonly LimitRSS?: NumericDirectiveValues;
  ...
  readonly LimitRTPRIO?: NumericDirectiveValues;
  ...
  readonly LimitRTTIME?: NumericDirectiveValues;
  ...
  readonly LimitSIGPENDING?: NumericDirectiveValues;
  ...
  readonly LimitSTACK?: NumericDirectiveValues;
  ...
  readonly LoadCredential?: NumericDirectiveValues;
  /** Pass a credential to the unit. Credentials are limited-size binary or textual objects that may be passed to unit processes. They are primarily intended for passing cryptographic keys (both public and private) or certificates, user account information or identity information from host to services, but can be freely used to pass any kind of limited-size information to a service. The data is accessible from the unit's processes via the file system, at a read-only location that (if possible and permitted) is backed by non-swappable memory. The data is only accessible to the user associated with the unit, via the User=/DynamicUser= settings (as well as the superuser). When available, the location of credentials is exported as the $CREDENTIALS_DIRECTORY environment variable to the unit's processes. Source: systemd v260.1, `systemd.exec(5)`. */
  readonly LoadCredentialEncrypted?: NumericDirectiveValues;
  ...
  readonly LockPersonality?: BooleanDirectiveValues;
  ...
  readonly LogExtraFields?: StringDirectiveValues;
  ...
  readonly LogFilterPatterns?: StringDirectiveValues;
  ...
  readonly LogLevelMax?: StringDirectiveValues;
  ...
  readonly LogNamespace?: StringDirectiveValues;
  ...
  readonly ManagedOOMMemoryPressureDurationSec?: DurationDirectiveValues;
  ...
  readonly ManagedOOMMemoryPressureLimit?: StringDirectiveValues;
  ...
  readonly ManagedOOMPreference?: StringDirectiveValues;
  ...
  readonly MemoryMin?: StringDirectiveValues;
  ...
  readonly MemoryPressureThresholdSec?: DurationDirectiveValues;
  ...
  readonly MountAPIVFS?: BooleanDirectiveValues;
  ...
  readonly MountFlags?: StringDirectiveValues;
  /** Takes an image policy string as per systemd.image-policy7 to use when mounting the disk images (DDI) specified in RootImage=, MountImage=, ExtensionImage=, respectively. If not specified the following policy string is the default for RootImagePolicy= and MountImagePolicy:. Source: systemd v260.1, `systemd.exec(5)`. */
  readonly MountImagePolicy?: StringDirectiveValues;
  ...
  readonly MountImages?: StringDirectiveValues;
  ...
  readonly NFTSet?: StringDirectiveValues;
  ...
  readonly NUMAMask?: StringDirectiveValues;
  ...
  readonly NUMAPolicy?: StringDirectiveValues;
  ...
  readonly NetworkNamespacePath?: StringDirectiveValues;
  ...
  readonly NoNewPrivileges?: BooleanDirectiveValues;
  ...
  readonly NonBlocking?: StringDirectiveValues;
  ...
  readonly NotifyAccess?: DirectiveValue<"none" | "main" | "exec" | "all">;
  ...
  readonly OOMPolicy?: DirectiveValue<"continue" | "stop" | "kill">;
  ...
  readonly OOMScoreAdjust?: NumericDirectiveValues;
  ...
  readonly OpenFile?: StringDirectiveValues;
  ...
  readonly PAMName?: StringDirectiveValues;
  ...
  readonly PIDFile?: StringDirectiveValues;
  ...
  readonly PassEnvironment?: StringDirectiveValues;
  ...
  readonly Personality?: StringDirectiveValues;
  ...
  readonly PrivateBPF?: BooleanDirectiveValues;
  ...
  readonly PrivateDevices?: BooleanDirectiveValues;
  ...
  readonly PrivateIPC?: BooleanDirectiveValues;
  ...
  readonly PrivateMounts?: StringDirectiveValues;
  ...
  readonly PrivateNetwork?: BooleanDirectiveValues;
  ...
  readonly PrivatePIDs?: BooleanDirectiveValues;
  ...
  readonly PrivateTmp?: DirectiveValue<boolean | "disconnected">;
  ...
  readonly PrivateUsers?: DirectiveValue<boolean | "self" | "identity" | "full" | "managed">;
  ...
  readonly ProcSubset?: StringDirectiveValues;
  ...
  readonly ProtectClock?: BooleanDirectiveValues;
  ...
  readonly ProtectControlGroups?: DirectiveValue<boolean | "private" | "strict">;
  ...
  readonly ProtectHome?: DirectiveValue<boolean | "read-only" | "tmpfs">;
  ...
  readonly ProtectHostname?: DirectiveValue<boolean | string>;
  ...
  readonly ProtectKernelLogs?: BooleanDirectiveValues;
  ...
  readonly ProtectKernelModules?: BooleanDirectiveValues;
  ...
  readonly ProtectKernelTunables?: BooleanDirectiveValues;
  ...
  readonly ProtectProc?: StringDirectiveValues;
  ...
  readonly ReadWritePaths?: StringDirectiveValues;
  ...
  readonly RefreshOnReload?: DirectiveValue<boolean | string>;
  ...
  readonly ReloadSignal?: SignalDirectiveValues;
  ...
  readonly RemainAfterExit?: BooleanDirectiveValues;
  ...
  readonly RemoveIPC?: StringDirectiveValues;
  ...
  readonly Restart?: DirectiveValue<
  ...
  readonly RestartForceExitStatus?: ExitStatusDirectiveValues;
  ...
  readonly RestartKillSignal?: SignalDirectiveValues;
  ...
  readonly RestartMaxDelaySec?: DurationDirectiveValues;
  ...
  readonly RestartMode?: DirectiveValue<"normal" | "direct" | "debug">;
  ...
  readonly RestartPreventExitStatus?: ExitStatusDirectiveValues;
  ...
  readonly RestartSec?: DurationDirectiveValues;
  ...
  readonly RestartSteps?: NumericDirectiveValues;
  ...
  readonly RestrictAddressFamilies?: StringDirectiveValues;
  ...
  readonly RestrictFileSystems?: StringDirectiveValues;
  ...
  readonly RestrictNamespaces?: BooleanDirectiveValues;
  ...
  readonly RestrictNetworkInterfaces?: StringDirectiveValues;
  ...
  readonly RestrictRealtime?: BooleanDirectiveValues;
  ...
  readonly RestrictSUIDSGID?: BooleanDirectiveValues;
  ...
  readonly RootDirectory?: StringDirectiveValues;
  ...
  readonly RootDirectoryStartOnly?: BooleanDirectiveValues;
  ...
  readonly RootEphemeral?: BooleanDirectiveValues;
  ...
  readonly RootHash?: StringDirectiveValues;
  ...
  readonly RootHashSignature?: StringDirectiveValues;
  ...
  readonly RootImage?: StringDirectiveValues;
  ...
  readonly RootImageOptions?: StringDirectiveValues;
  /** Takes an image policy string as per systemd.image-policy7 to use when mounting the disk images (DDI) specified in RootImage=, MountImage=, ExtensionImage=, respectively. If not specified the following policy string is the default for RootImagePolicy= and MountImagePolicy:. Source: systemd v260.1, `systemd.exec(5)`. */
  readonly RootImagePolicy?: StringDirectiveValues;
  ...
  readonly RootMStack?: StringDirectiveValues;
  ...
  readonly RuntimeDirectoryPreserve?: DirectiveValue<boolean | "restart">;
  ...
  readonly RuntimeMaxSec?: DurationDirectiveValues;
  ...
  readonly RuntimeRandomizedExtraSec?: DurationDirectiveValues;
  ...
  readonly SELinuxContext?: StringDirectiveValues;
  ...
  readonly SecureBits?: StringDirectiveValues;
  ...
  readonly SendSIGHUP?: StringDirectiveValues;
  ...
  readonly SendSIGKILL?: StringDirectiveValues;
  ...
  readonly SetCredential?: StringDirectiveValues;
  /** The SetCredential= setting is similar to LoadCredential= but accepts a literal value to use as data for the credential, instead of a file system path to read the data from. Do not use this option for data that is supposed to be secret, as it is accessible to unprivileged processes via IPC. It's only safe to use this for user IDs, public key material and similar non-sensitive data. For everything else use LoadCredential=. In order to embed binary data into the credential data use C-style escaping (i.e. \n to embed a newline, or \x00 to embed a NUL byte). Source: systemd v260.1, `systemd.exec(5)`. */
  readonly SetCredentialEncrypted?: StringDirectiveValues;
  ...
  readonly SetLoginEnvironment?: StringDirectiveValues;
  ...
  readonly Slice?: StringDirectiveValues;
  ...
  readonly SmackProcessLabel?: StringDirectiveValues;
  ...
  readonly SocketBindAllow?: StringDirectiveValues;
  /** See systemd.service(5) for SocketBindDeny=. Source: systemd v260.1, `systemd.service(5)`. */
  readonly SocketBindDeny?: StringDirectiveValues;
  ...
  readonly Sockets?: UnitNameDirectiveValues;
  ...
  readonly StandardError?: StringDirectiveValues;
  ...
  readonly StandardInput?: StringDirectiveValues;
  ...
  readonly StandardInputData?: StringDirectiveValues;
  /** Configures arbitrary textual or binary data to pass via file descriptor 0 (STDIN) to the executed processes. These settings have no effect unless StandardInput= is set to data (which is the default if StandardInput= is not set otherwise, but StandardInputText=/StandardInputData= is). Use this option to embed process input data directly in the unit file. Source: systemd v260.1, `systemd.exec(5)`. */
  readonly StandardInputText?: StringDirectiveValues;
  ...
  readonly SuccessExitStatus?: ExitStatusDirectiveValues;
  ...
  readonly SupplementaryGroups?: StringDirectiveValues;
  ...
  readonly SyslogFacility?: StringDirectiveValues;
  ...
  readonly SyslogIdentifier?: StringDirectiveValues;
  ...
  readonly SyslogLevel?: StringDirectiveValues;
  ...
  readonly SyslogLevelPrefix?: BooleanDirectiveValues;
  ...
  readonly SystemCallArchitectures?: StringDirectiveValues;
  ...
  readonly SystemCallErrorNumber?: StringDirectiveValues;
  ...
  readonly SystemCallFilter?: StringDirectiveValues;
  ...
  readonly SystemCallLog?: StringDirectiveValues;
  ...
  readonly TTYColumns?: NumericDirectiveValues;
  ...
  readonly TTYPath?: StringDirectiveValues;
  ...
  readonly TTYReset?: StringDirectiveValues;
  /** Configure the size of the TTY specified with TTYPath=. If unset or set to the empty string, it is attempted to retrieve the dimensions of the terminal screen via ANSI sequences, and if that fails the kernel defaults (typically 80x24) are used. Source: systemd v260.1, `systemd.exec(5)`. */
  readonly TTYRows?: NumericDirectiveValues;
  ...
  readonly TTYVHangup?: StringDirectiveValues;
  ...
  readonly TTYVTDisallocate?: StringDirectiveValues;
  /** This setting controls the pids controller in the unified hierarchy. Source: systemd v260.1, `systemd.resource-control(5)`. */
  readonly TasksAccounting?: StringDirectiveValues;
  /** This setting controls the pids controller in the unified hierarchy. Source: systemd v260.1, `systemd.resource-control(5)`. */
  readonly TasksMax?: NumericDirectiveValues;
  ...
  readonly TemporaryFileSystem?: NumericDirectiveValues;
  ...
  readonly TimeoutAbortSec?: DurationDirectiveValues;
  ...
  readonly TimeoutSec?: DurationDirectiveValues;
  ...
  readonly TimeoutCleanSec?: DurationDirectiveValues;
  ...
  readonly TimeoutStartFailureMode?: StringDirectiveValues;
  ...
  readonly TimeoutStartSec?: DurationDirectiveValues;
  /** These options configure the action that is taken in case a daemon service does not signal start-up within its configured TimeoutStartSec=, respectively if it does not stop within TimeoutStopSec=. Takes one of terminate, abort and kill. Both options default to terminate. Source: systemd v260.1, `systemd.service(5)`. */
  readonly TimeoutStopFailureMode?: StringDirectiveValues;
  ...
  readonly TimeoutStopSec?: DurationDirectiveValues;
  ...
  readonly TimerSlackNSec?: DurationDirectiveValues;
  ...
  readonly UMask?: StringDirectiveValues;
  ...
  readonly USBFunctionDescriptors?: StringDirectiveValues;
  ...
  readonly USBFunctionStrings?: StringDirectiveValues;
  ...
  readonly UnsetEnvironment?: StringDirectiveValues;
  /** Set the UNIX user or group that the processes are executed as, respectively. Takes a single user or group name, or a numeric ID as argument. For system services (services run by the system service manager, i.e. managed by PID 1) and for user services of the root user (services managed by root's instance of systemd --user), the default is root, but User= may be used to specify a different user. For user services of any other user, switching user identity is not permitted, hence the only valid setting is the same user the user's service manager is running as. If no group is set, the default group of the user is used. This setting does not affect commands whose command line is prefixed with +. Source: systemd v260.1, `systemd.exec(5)`. */
  readonly User?: StringDirectiveValues;
  ...
  readonly UserNamespacePath?: StringDirectiveValues;
  ...
  readonly UtmpIdentifier?: StringDirectiveValues;
  ...
  readonly UtmpMode?: StringDirectiveValues;
  ...
  readonly WatchdogSec?: DurationDirectiveValues;
  ...
  readonly WatchdogSignal?: StringDirectiveValues;
  ...
  readonly WorkingDirectory?: StringDirectiveValues;
}
